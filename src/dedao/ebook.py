    ...
    def get_ebook_detail(self, enid: str) -> EbookDetail:
        ...
        for item in catalog_list:
            catalog.append(EbookCatalog(
                chapter_id=str(item.get("chapter_id") or item.get("id", "")),
        ...
        ebook = EbookDetail(
            enid=enid,
            title=book_data.get("title") or book_data.get("name", "未知电子书"),
            cover=book_data.get("cover") or book_data.get("logo", ""),
            author=book_data.get("author_name") or book_data.get("author", ""),
